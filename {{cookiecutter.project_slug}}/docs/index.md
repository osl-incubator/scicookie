...
{% endif -%} {%- if cookiecutter.use_ruff_formatter == "yes" -%}
[![Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)
{% endif -%} {%- if cookiecutter.use_prettier == "yes" -%}
...
{% endif -%} {%- if cookiecutter.use_hypothesis == "yes" -%}
...
![Makim](https://img.shields.io/badge/Automation%20task-Makim-blue) {% endif -%}
...
- Documentation: {{ cookiecutter.documentation_url }} {%- endif %}
